...
setwd("~/Corsi/Statistica Applicata/Applied Statistics MATE 21-22/Lab 5 - 24032022")
...
# have no evidence of non-gaussianity, i.e., we can assume that the transformed
# data are Gaussian
