...
```{r }
plastic <- read.table(here::here('markdowns','lab_7_data','T6-4.dat'),col.names=c('Ex','Ad','Tr','Gl','Op'))
plastic
...
```{r }
penguins <- read.table(here::here('markdowns','lab_7_data','penguins.txt'), header=T)
head(penguins)
