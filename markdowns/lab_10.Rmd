...
setwd("~/Corsi/Statistica Applicata/Applied Statistics MATE 21-22/Lab 10 - 09052022")
...
x <- seq(0,30,by=0.1)
b <- coef(fm)
lines(x, b[1]+b[2]*x+b[3]*x^2) # add the model
...
hypothesis.matrix <- rbind(c(0,1,0),
                           c(0,0,1))
linearHypothesis(fm, hypothesis.matrix, c(0,0)) 
summary(fm)
...
# cfr. https://www.rdocumentation.org/packages/asbio/versions/1.6-7/topics/anscombe
###---------------------------------
